...
export default function Feature() {
  return (
    <section className="container my-16">
      <div className="grid grid-cols-2 md:grid-cols-4 content-center rounded-lg">
        <div className="flex justify-center items-center gap-x-2 h-20 border md:p-2 border-gray-400 md:border-r-0">
          <svg
