...
export default function Carddd() {
  return (
    <div className="flex flex-col justify-center items-center w-[18rem] border border-black my-4 mx-auto">
      <div className="relative flex">
        <img className="w-full" src="sam.png" alt="sofa image" />
        ...
        <div className="absolute right-1 mt-3 flex items-center justify-center bg-amber-400">
          <p className="px-2 py-2 text-sm">25% OFF</p>
        </div>
      </div>
