          ...
          <div
            ...
            <div className="relative">
              <img
                ...
                loading="lazy"
              />
              <span className="absolute top-4 left-4 bg-red-500 p-2">
              ...
              <div className="px-5 pb-2">
                ...
                <div className="flex items-center justify-start gap-4 font-semibold">
                  <p className=" text-red-600 text-center text-lg font-bold flex gap-x-1">
                    Ksh
                    <span>
                      {product.price -
            ...
            <div className="absolute top-4 right-3 grid grid-flow-row gap-3 group/edit invisible group-hover/item:visible p-1">
              <a
                ...
                <p className="absolute invisible group-hover/icon:visible animate-bounce right-5 top-2 bottom-0 text-xs 2xl:text-md text-center w-28 my-auto text-white font-semibold">
                  Product Details
                </p>
              </a>
              <a className="bg-yellow-400 p-1 relative group/icon" href="">
                ...
                <p className="absolute invisible group-hover/icon:visible animate-bounce right-5 top-2 bottom-0 text-xs 2xl:text-md text-center w-32 my-auto text-black font-semibold">
                  Add to Wishlist
                </p>
              </a>
              <a className="bg-yellow-400 p-1 relative group/icon" href="">
                ...
                <p className="absolute invisible group-hover/icon:visible animate-bounce right-5 top-2 bottom-0 text-xs 2xl:text-md text-center w-36 my-auto text-black font-semibold">
                  Compare Products
                </p>
              </a>
              <a
